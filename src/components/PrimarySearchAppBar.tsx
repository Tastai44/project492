...
//         sx={{ padding: "20px", gap: "10px", margin:1, backgroundColor:"white", borderRadius:"10px"  }}>
//         <Avatar src={Luffy} /> Tastai Khianjai
//       </MenuItem>
//       <Divider style={{background:"white"}}/>
//       <MenuItem onClick={handleMenuClose} sx={{ padding: "20px", color:"white" }}>
//         <ListItemIcon>
...
//   return (
//     <Box sx={{ flexGrow: 1 }}>
//       <AppBar position="static" sx={{ backgroundColor: "#8E51E2" }}>
//         <Toolbar>
//           <IconButton
//             size="large"
//             edge="start"
